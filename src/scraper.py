...
def lagos_house_scraping(url):
    ...
    try:
        ...
        print(f"Successfully fetched main page: {url}")
    ...
    print("Beginning scraping logic...")
    locations = main_soup.select('a.location-banner-inner')
    print(f"Identified {len(locations)} major locations from the main page.")
    ...
    for links in locations:
            ...
            print(f"Starting pagination loop for location URL: {location_url}")
